			...
			<ol class="property-list enrollment">
				...
				<li class="fieldcontain">
					<span id="regClass-label" class="property-label"><g:message code="enrollment.regClass.label" default="Reg Class" /></span>
						...
						<span class="property-value" aria-labelledby="regClass-label"><g:link controller="class" action="show" id="${enrollmentInstance?.regClass?.id}">${enrollmentInstance?.regClass?.encodeAsHTML()}</g:link></span>
